...
const AnnotatedGallery = () => (
    <GalleryPageW>
      <p style={{ fontSize: "1.5em" }}>
        This gallery shows advanced use cases of LogosJ, including the use of various
        SVG elements to annotate logos. Users with knowledge of SVG can take advantage
        of the flexibility of LogosJ to create highly customized and interactive logos.
      </p>
